...
public class Player extends AbstractCharacter{   
    ...
    public Player(int id, Point point) {
        ...
        setFallingSound(
            ...
            Launcher.getInstance().manager.get("com/BombingGames/WurfelEngine/Game/Sounds/wind.ogg")
        );
        setRunningSound(
            (com.badlogic.gdx.backends.openal.Ogg.Sound)
            Launcher.getInstance().manager.get("com/BombingGames/WurfelEngine/Game/Sounds/victorcenusa_running.ogg")
        );
        setJumpingSound((com.badlogic.gdx.backends.openal.Wav.Sound)
            Launcher.getInstance().manager.get("com/BombingGames/WurfelEngine/Game/Sounds/jump_man.wav")
        );
        setLandingSound((com.badlogic.gdx.backends.openal.Wav.Sound)
            Launcher.getInstance().manager.get("com/BombingGames/WurfelEngine/Game/Sounds/landing.wav")
        );
