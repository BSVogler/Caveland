...
public class LoadingScreen implements Screen {
    ...
    public void show() {
        ...
        TextureAtlas atlas = WurfelEngine.getInstance().manager.get("com/BombingGames/EngineCore/Loading/loading.pack", TextureAtlas.class);
    ...
    public void hide() {
        ...
        WurfelEngine.getInstance().manager.unload("com/BombingGames/EngineCore/Loading/loading.pack");
    }
