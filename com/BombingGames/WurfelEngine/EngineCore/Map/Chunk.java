package com.BombingGames.WurfelEngine.EngineCore.Map;
        ...
        try {
            ...
            if (!Launcher.isFullscreen()) {
                JOptionPane.showMessageDialog(
                    null,
                    "The meta file could not be read. It must be named 'map."+ Chunk.METAFILESUFFIX + "' and must be at the maps directory:"+ Launcher.getWorkingDirectory().getAbsolutePath() + "/map/",
                    "Loading error",
