...
import com.BombingGames.WurfelEngine.EngineCore.WorkingDirectory;
...
public class Launcher extends Game {
     ...
     */
    private Launcher(String title, String[] args){
    ...
    public static void construct(String title, String[] args){
        instance = new Launcher(title,args);
    }
   ...
   /**
    ...
    public static void setFullscreen(boolean fullscreen) {
        ...
        Gdx.app.debug("Wurfel Engine","Set to fullscreen:"+fullscreen + " It is now:"+Launcher.isFullscreen());
    }
