...
import com.BombingGames.WurfelEngine.EngineCore.Loading.LoadingController;
import com.BombingGames.WurfelEngine.EngineCore.Loading.LoadingScreen;
...
public class GameplayScreen implements Screen{ 
  /**
    ...
    public GameplayScreen(Controller controller, View view) {
        ...
        loadingController.init(Launcher.getInstance().manager);

        Launcher.getInstance().setScreen(new LoadingScreen(loadingController));
    ...
    public void resize(int width, int height) {
        Gdx.graphics.setTitle("Wurfelengine V" + Launcher.VERSION + " " + Gdx.graphics.getWidth() + "x"+Gdx.graphics.getHeight());
    }
